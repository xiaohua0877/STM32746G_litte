...
const  NET_DEV_CFG_ETHER  NetDev_Cfg_STM32F746_0 = {
    ...
    1520u,                          /* Desired size      of device's large receive  buffers (in octets) [see Note #2].  */
      12u,                          /* Desired number    of device's large receive  buffers             [see Note #3a]. */
    ...
    1614u,                          /* Desired size      of device's large transmit buffers (in octets) [see Note #2].  */
      ...
      64u,                          /* Desired size      of device's small transmit buffers (in octets) [see Note #2].  */
    ...
    NET_DEV_CFG_FLAG_NONE,          /* Desired option flags, if any (see Note #6).                                      */
             ...
             14u,                    /* Desired number of device's transmit descriptors.                                 */
...
const  NET_PHY_CFG_ETHER  NetPhy_Cfg_STM32F746G_DISCO_0 = {
