...
#define  NET_CFG_IF_RX_Q_SIZE                   20u             /*Configure RX queue size (See Note #1).                */
#define  NET_CFG_IF_TX_DEALLOC_Q_SIZE           20u             /*Configure TX queue size (See Note #2).                */
...
#define  NET_SOCK_CFG_SOCK_NBR_TCP              7u              /* Configure number of TCP connections.                 */
...
#define  NET_SOCK_CFG_CONN_ACCEPT_Q_SIZE_MAX    2u              /* maximum size. (See Note # 1)                         */
                                                                ...
                                                                /* (see Note #2):                                       */
#define  NET_SOCK_CFG_RX_Q_SIZE_OCTET         (15 * 1460u)       /* Configure socket receive  queue buffer size.         */
...
#define  NET_SECURE_CFG_MAX_NBR_SOCK_SERVER     3u              /* Configure total number of server secure sockets.     */
#define  NET_SECURE_CFG_MAX_NBR_SOCK_CLIENT     1u              /* Configure total number of client secure sockets.     */
...
#define  NET_SECURE_CFG_MAX_CA_CERT_LEN         1900u           /* Configure CA certificate maximum length (bytes)      */
