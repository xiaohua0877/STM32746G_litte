...
#define  HTTPc_APP_FS_MODULE_PRESENT   APP_CFG_FS_EN
...
#define  HTTP_SERVER_HOSTNAME                          "mqtt.micrium.com"

#define  HTTPc_APP_CFG_URI                             "/ssldemo"
#define  HTTPc_APP_CFG_RESP_BUF_SIZE                   2048u

#if (NET_CFG_SECURE_EN == DEF_ENABLED)
#define  HTTPc_APP_CFG_CONN_NBR_MAX                    NET_SECURE_CFG_MAX_NBR_SOCK_CLIENT
#else
#define  HTTPc_APP_CFG_CONN_NBR_MAX                       1u
#endif

#define  HTTPc_APP_CFG_REQ_NBR_MAX                        5u
#define  HTTPc_APP_CFG_CONN_BUF_SIZE                   4096u
...
HTTPc_APP_EXT  CPU_CHAR              HTTPcApp_Buf[1024];

#if (HTTPc_APP_CFG_CONN_NBR_MAX > 0u)
