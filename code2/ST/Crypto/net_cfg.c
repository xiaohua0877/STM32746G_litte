...
const  NET_TASK_CFG  NetRxTaskCfg = {
       ...
       (NET_CFG_TASK_RX_STK_SIZE * 4),                          /* RX task stack size in bytes         (see Note #2).   */
...
const  NET_TASK_CFG  NetTxDeallocTaskCfg = {
       ...
       (NET_CFG_TASK_TX_DEALLOC_STK_SIZE * 4),                  /* TX Dealloc task stack size in bytes (see Note #2).   */
...
const  NET_TASK_CFG  NetTmrTaskCfg = {
       ...
       (NET_CFG_TASK_TMR_STK_SIZE * 4),                         /* Timer task stack size in bytes      (see Note #2).   */
