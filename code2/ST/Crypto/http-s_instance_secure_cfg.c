...
*
*                   HTTPs_OS_CFG_INSTANCE_SECURE_TASK_PRIO
*                   HTTPs_OS_CFG_INSTANCE_SECURE_TASK_STK_SIZE
*
*********************************************************************************************************
*********************************************************************************************************
*/
...
extern  const     HTTPs_HOOK_CFG         HTTPs_Hooks;
#ifdef NET_SECURE_EMSSL_MODULE
extern            SSL_ROOT_CERTIFICATE   Segger_SelfSigned_Certificate;
extern  unsigned  char  const            Segger_RSA_PrivKey[];
extern  unsigned  char  const            Segger_SelfSigned_Certificate_DER[];
#endif
...
*               (a) However, if using a PEM-formatted certificate with SEGGER's emSSL stack, it will need to 
*                   converted to DER format prior to installing it. This is achieved by using the PrintCert.exe 
*                   Windows command line utility that ships with their source and is also available online at 
*                   https://www.segger.com/downloads/emssl. Finally, NET_SOCK_SECURE_CERT_KEY_FMT_DER should be 
*                   the only format assigned to the instance configuration structure's .Fmt field.
*
...
#define HTTPs_CFG_SECURE_CERT      (CPU_CHAR *)&Segger_SelfSigned_Certificate
#define HTTPs_CFG_SECURE_KEY       (CPU_CHAR *)&Segger_RSA_PrivKey
#define HTTPs_CFG_SECURE_CERT_LEN               SSL_RSA_CERTIFICATE_DER_SIZE
#define HTTPs_CFG_SECURE_KEY_LEN                SSL_RSA_PRIVKEY_SIZE        
...
HTTPs_SECURE_CFG  HTTPs_Cfg_InstanceSecure = {
                                                HTTPs_CFG_SECURE_CERT,              /* Pointer to cert's string.        */
                                                HTTPs_CFG_SECURE_CERT_LEN,          /* Length of the public cert.       */
                                                HTTPs_CFG_SECURE_KEY,               /* Pointer to key's string.         */
                                                HTTPs_CFG_SECURE_KEY_LEN,           /* Length of the key.               */
                                                NET_SOCK_SECURE_CERT_KEY_FMT_DER,   /* Format (see note #2):            */
                                                DEF_NO,                             /* Chained certificate.             */
                                             };
...
const  NET_TASK_CFG  HTTPs_TaskCfgInstance_Secure = {
...
#if 0
const  HTTPs_CFG_FS_NONE  HTTPs_CfgFS_None_Secure = {
...
#if 1
const  HTTPs_CFG_FS_STATIC  HTTPs_CfgFS_Static_Secure = {
...
#if 0
const  HTTPs_CFG_FS_DYN  HTTPs_CfgFS_Dyn_Secure = {
   ...
   &NetFS_API_FS_V4,
    ...
    HTTPs_CFG_INSTANCE_SECURE_STR_FOLDER_ROOT
...
const  HTTPs_HDR_RX_CFG  HTTPs_HdrRxCfg_Secure = {
...
const  HTTPs_HDR_TX_CFG  HTTPs_HdrTxCfg_Secure = {
...
const  HTTPs_QUERY_STR_CFG    HTTPs_QueryStrCfg_Secure = {
    /* CPU_INT16U   NbrPerConnMax                                                                                       */
...
const  HTTPs_FORM_CFG     HTTPs_FormCfg_Secure = {
    ...
    HTTPs_CFG_INSTANCE_SECURE_STR_FOLDER_UPLOAD,
                                                                /* SHOULD be a string pointer.                          */
};
...
const  HTTPs_TOKEN_CFG   HTTPs_TokenCfg_Secure = {
...
const  HTTPs_CFG  HTTPs_CfgInstance_Secure = {
...
*                   supported by uC/TCPIP-V3 such as:
*
*                   (i) emSSL provided by SEGGER.
*
...
*/
   ...
   &HTTPs_CfgFS_Static_Secure,

    /* CPU_CHAR    *DfltResourceNamePtr                                                                                 */
                                                                /* Configure instance default page (see note #2):       */
    HTTPs_CFG_INSTANCE_SECURE_STR_FILE_DEFAULT,
...
*
*           (3) To enable the Header feature supports in HTTP response, set the pointer to the Response Header configuration object.
