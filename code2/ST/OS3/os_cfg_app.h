...
#define  OS_CFG_TICK_TASK_PRIO                         1u       /* Priority                                             *///Yanko: for compatibility with 3.06.00
#define  OS_CFG_TICK_TASK_STK_SIZE                  1024u       /* Stack size (number of CPU_STK elements)              *///Yanko: for compatibility with 3.06.00
